...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['http://localhost:3001','http://localhost:3000','https://frontend-jagger-production.up.railway.app'], // o true para permitir todos los orígenes (no recomendado en producción)
